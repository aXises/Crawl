        ...
        for (String exit : room.getExits().keySet()) {
            switch(exit) {
                case "North":
                    ...
                    break;
                case "South":
                    gc.strokeLine(xPos+(length/2), yPos+length,
                            xPos+(length/2), yPos+length+5);
                    break;
                case "East":
                    gc.strokeLine(xPos+length, yPos+(length/2),
                            xPos+length+5, yPos+(length/2));
                    break;
                case "West":
                    gc.strokeLine(xPos, yPos+(length/2), xPos-5,
                            yPos+(length/2));
                    break;
                default:
                    break;
